  ...
  <q-layout view="lHh Lpr fff" class="bg-grey-1">
    <q-header elevated class="bg-white text-grey-8" height-hint="64">
      <q-toolbar class="GPL__toolbar" style="height: 64px">
        ...
        <q-btn v-if="$q.screen.gt.xs && false" flat dense no-wrap color="primary" icon="add" no-caps label="Create" class="q-ml-sm q-px-md">
        ...
        <q-btn v-if="$q.screen.gt.xs && false" flat dense no-wrap color="primary" icon="cloud_upload" no-caps label="Upload" class="q-ml-sm q-px-md" />
    ...
    <q-page-container class="GPL__page-container">
      ...
      <q-page-sticky  v-if="$q.screen.gt.sm && false" expand position="left">
